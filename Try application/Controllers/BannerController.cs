...
namespace Try_application.Controllers
{
    ...
    public class BannersController : ControllerBase
    {
        ...
        {
            // Use projection to avoid the CreatedAt column issue
        ...
        public IActionResult GetActiveBanner()
        {
            ...
            {
                return StatusCode(500, new { message = "Error retrieving active banner.", error = ex.Message });
            }
        }
        ...
        public async Task<IActionResult> CreateBanner([FromForm] BannerDto dto, IFormFile? image)
        {
            ...
            // Return without accessing CreatedAt
            return Ok(new
            {
                banner.Id,
                banner.Title,
        ...
        public async Task<IActionResult> DeactivateAllBanners()
        {
            foreach (var b in _context.Banners)
                b.IsActive = false;

            await _context.SaveChangesAsync();
            return Ok(new { message = "All banners deactivated." });
        }
